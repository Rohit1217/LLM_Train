...
data_splits={"fineweb_edu":{"tok_frac":0.57,"path":"../raw_corpus_optimized/fineweb-edu-10BT/sample/10BT/000_00000.parquet","num_parquets":17}, 
             "fine_math":{"tok_frac":0.28,"path":"../raw_corpus_optimized/finemath_4plus.jsonl.zst"},
              "stack_python":{"tok_frac":0.15*0.5,"path":"../raw_corpus_optimized/stack_python_dedup.jsonl.zst"},
              "stack_cpp":{"tok_frac":0.15*0.2,"path":"../raw_corpus_optimized/stack_cpp_dedup.jsonl.zst" },
              "stack_tex":{"tok_frac":0.15*0.2,"path":"../raw_corpus_optimized/stack_tex_dedup.jsonl.zst" },
              "stack_sql":{"tok_frac":0.15*0.1,"path":"../raw_corpus_optimized/stack_sql_dedup.jsonl.zst" },}
...
if __name__=="__main__":
    create_token_arr(data_splits,TOTAL_TOKEN_COUNT,"../raw_corpus_optimized/tokens.bin")